...
class LlmResponseParser:
    ...
    def MakeMove(
        ...
        result = self.__options.merge_options(baml_options).parse_response(function_name="MakeMove", llm_response=llm_response, mode="request")
...
class LlmStreamParser:
    ...
    def MakeMove(
        ...
        result = self.__options.merge_options(baml_options).parse_response(function_name="MakeMove", llm_response=llm_response, mode="stream")
        return typing.cast(int, result)
