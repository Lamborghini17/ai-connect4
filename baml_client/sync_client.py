...
class BamlSyncClient:
    ...
    def MakeMove(self, board: typing.List[typing.List[str]],player: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="MakeMove", args={
...
class BamlStreamClient:
    ...
    def MakeMove(self, board: typing.List[typing.List[str]],player: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="MakeMove", args={
            "board": board,"player": player,
        })
...
class BamlHttpRequestClient:
    ...
    def MakeMove(self, board: typing.List[typing.List[str]],player: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="MakeMove", args={
            "board": board,"player": player,
        }, mode="request")
        return result
