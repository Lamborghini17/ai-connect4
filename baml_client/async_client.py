...
class BamlAsyncClient:
    ...
    async def MakeMove(self, board: typing.List[typing.List[str]],player: str,
        baml_options: BamlCallOptions = {},
    ) -> int:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.MakeMove(board=board,player=player,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="MakeMove", args={
...
class BamlStreamClient:
    ...
    def MakeMove(self, board: typing.List[typing.List[str]],player: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[int, int]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="MakeMove", args={
            "board": board,"player": player,
        })
...
class BamlHttpRequestClient:
    ...
    async def MakeMove(self, board: typing.List[typing.List[str]],player: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="MakeMove", args={
            "board": board,"player": player,
        }, mode="request")
        return result
